class Endpoint {
  static const String baseUrlApi = "http://192.168.1.2:8000/api/users/";

  static const String profil = "${baseUrlApi}profil";
  static const String updateProfile = "${baseUrlApi}update";
  ...
  static const String popular = "${baseUrlApi}popular";
